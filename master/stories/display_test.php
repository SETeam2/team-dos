...
include('../php_components/navigation_bar.php');
// variables
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="\stories\add_story.php">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="control-label">Story ID:</label>
                        <input type="text" class="form-control" name="story_id" required="required">
                    </div>
                    <div class="form-group">
                        <label class="control-label">Title</label>
                        <input type="text" class="form-control" name="story_title" required="required">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="created_by_developer" required="required"></textarea>
                    </div>
                </div>

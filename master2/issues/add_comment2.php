...
$sql = "INSERT INTO task_comments (issue_id, created_by_developer, comment) VALUES ('$issueid', '{$_SESSION['user']['id']}', '$comment_text')";

if ($conn->query($sql) === TRUE) {
    echo "New record created successfully. ";

    // update "last_updated" timestamp
    $sql = "UPDATE tasks SET last_updated=CURRENT_TIMESTAMP WHERE id='$issueid'";
